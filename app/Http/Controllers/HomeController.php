...
class HomeController extends Controller
{
    public function index(Request $request){
        ...
        $all_product_sale = Product::where('product_status','0')->where('product_sale','!=',null)->orderBy('product_price','asc')->limit(12)->get();
        ...
        return view('pages.home')->with(compact('all_product_sale','category','all_product','banner','all_slider','all_sponsor','all_course','all_activity','meta_desc','meta_keywords','meta_title','url_canonical'));
    }
    ...
    public function product_by_category($category_id,Request $request)
    {
        $meta_desc = "Chuyên bán máy ảnh và phụ kiện máy ảnh";
        $meta_keywords = "may anh, máy ảnh, phụ kiện,phu kien, phụ kiện máy ảnh, phu kien may anh";
        $meta_title = "LJShop.vn | Sản phẩm theo thương hiệu";
        $url_canonical = $request->url();
